    ...
    function create( $id = false )
    {
		...
		switch ( $_SERVER ['REQUEST_METHOD'] )
        {
            case 'GET':
                ...
                $user_profile_set = $this->model_event->related_user_profile();
            ...
            case 'POST':
				...
				$this->form_validation->set_rules( 'place_id', lang('place_id'), 'required|max_length[11]|integer' );
				...
				$data_post['place_id'] = $this->input->post( 'place_id' );
