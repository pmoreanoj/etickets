        ...
        switch ($_SERVER ['REQUEST_METHOD']) {
            ...
            case 'POST':
                ...
                if ($this->form_validation->run() == FALSE || $this->uploader->success == FALSE ) {
                    ...
                    $this->form_validation->run() == FALSE ? print "true" : print "false";
                    $this->uploader->success == FALSE ? print "true" : print "false";
                    $this->uploader->required_empty !== FALSE ? print "true" : print "false";
